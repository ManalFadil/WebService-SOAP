 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://example.org/", wsdlLocation = "http://localhost:6655/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://example.org/", "BanqueWS");
